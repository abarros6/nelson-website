...
export const GALLERY_PHOTOS: GalleryPhoto[] = [
  // Exterior Railings
  { id: 'er-1', category: 'Exterior Railings', label: 'Glass & Steel Exterior Railing', color: '#3d4f5c', accentColor: '#5a7080' },
  ...
  { id: 'ir-4', category: 'Interior Railings', label: 'Glass Panel Stair Rail', color: '#404850', accentColor: '#586068' },
